...
export default function MarketingHome() {
  const [form, setForm] = useState({ role: 'VP of Strategy', industry: 'FinTech' });
    ...
    <main>
      ...
      <section id="features" className="py-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <FeatureItem icon={<Search size={24} className="text-purple-400" />}  title="Comprehensive coverage" description="500 k+ sources scanned every day so you never miss a signal." />
          <FeatureItem icon={<BarChart size={24} className="text-purple-400" />} title="Actionable insights"     description="Every story ships with an executive summary and first-draft commentary." />
